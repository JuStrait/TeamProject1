...
function success(position) {
  ...
  var queryURL =
    ...
    "&lon=" +
    lon +
    "&APPID=af8f0cf02906080babb5b0971511a2f6";
  $.ajax({
    url: queryURL,
    method: "GET",
...
function getCurrent(city) {
  var queryURL =
    ...
    city +
    "&APPID=af8f0cf02906080babb5b0971511a2f6&units=imperial";
  $.ajax({
    url: queryURL,
    method: "GET",
    error: function () {
    ...
    //get UV Index
    var uvURL =
      "https://api.openweathermap.org/data/2.5/uvi?appid=af8f0cf02906080babb5b0971511a2f6&lat=" +
      response.coord.lat +
      "&lon=" +
      response.coord.lat;
    $.ajax({
